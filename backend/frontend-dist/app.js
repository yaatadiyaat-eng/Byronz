...
const AUTO_MODEL_PRIORITY = {
  ...
  code: ["llama3:latest", "mistral:latest"],
  english_tutor: ["llama3:latest", "mistral:latest"],
  business: ["llama3:latest", "mistral:latest"],
  creative: ["mistral:latest", "llama3:latest"],
  data_analysis: ["llama3:latest", "mistral:latest"],
  chatbot: ["mistral:latest", "llama3:latest"],
  vision: ["llama3:latest", "mistral:latest"],
  automation: ["llama3:latest", "mistral:latest"],
  researcher: ["llama3:latest", "mistral:latest"]
};
...
function prettifyModelName(modelName) {
  const baseName = String(modelName || "").split(":", 1)[0].replace(/[-_]+/g, " ").trim();
  if (!baseName) {
    return "Model";
  }
  ...
  return aliases[baseName.toLowerCase()] || baseName.replace(/\b\w/g, (letter) => letter.toUpperCase());
}
